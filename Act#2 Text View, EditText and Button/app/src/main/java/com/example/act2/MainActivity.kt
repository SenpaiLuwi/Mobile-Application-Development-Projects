    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.SendBtn.setOnClickListener {
            ...
            if (firstName.isBlank() || lastName.isBlank() || miName.isBlank()) {
                ...
                binding.TextArea.text = "The Text Will Appear Here"
            } else {
        ...
        binding.FirstNameEdit.showSoftInputOnFocus = false
        binding.LastNameEdit.showSoftInputOnFocus = false
        binding.MINameEdit.showSoftInputOnFocus = false
    }
